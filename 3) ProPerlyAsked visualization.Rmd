...
main_df <- mutate(
  ...
  ##  f0 post smooth_stretch_interp_smooth ('f0Post')
    ...
    f0_CCPost = f0_CCsmootchInterpSplin,
...
mini_main_df <- droplevels(subset(main_df, select = -c(intensity, periodicStrength, totalPower, periodicPower, max_data_per_power, max_data_strength, max_speaker_per_power, max_speaker_strength, max_token_per_power, max_token_strength, perFloor_indeed, periodicFraction, postPP, logPP)))
