...
main_df <- mutate(
  ...
  # f0_data_min = round(min(f0_CC, na.rm=T)),
  # f0_data_max = round(max(f0_CC, na.rm=T)),
...
main_df <- mutate(
  ...
  # f0_token_min = round(min(f0_CC, na.rm=T)),
  # f0_token_max = round(max(f0_CC, na.rm=T)),
  # f0_token_median = round(median(f0_CC, na.rm = T)),
  # f0_token_mean = round(mean(f0_CC, na.rm = T)),
...
if(length(main_df$speaker)>0) main_df <- mutate(group_by(main_df, speaker),
  ...
  # f0_speaker_min = round(min(f0_CC, na.rm=T)),
  # f0_speaker_max = round(max(f0_CC, na.rm=T)),
  ...
  # f0_speaker_median = round(median(f0_CC, na.rm = T)),
  # f0_speaker_mean = round(mean(f0_CC, na.rm = T)),
