...
fullTimeF0_CC_df <- mutate(
  ...
  ##  f0_smooth_stretch_interp ('f0_smootchInterp')
    f0_CCsmootchInterpLin = round(na.approx(f0_CCsmootch)),
    f0_CCsmootchInterpSplin = round(na.spline(f0_CCsmootch))
  ##  f0 post smooth_stretch_interp_smooth ('f0Post')
  # f0_CCPost = round(bwfilter(wave = f0_CCsmootchInterp, f = 1000, to = 12, n = 1, output = "Sample"), 2)
  )
